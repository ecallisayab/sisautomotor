    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <a class="btn btn-secondary btn-sm" href="{{ route('permiso.index') }}">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('permiso.update',$permiso->id) }}" method="POST" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-6">
